...
_(снять после публикации репо)_

- `docs/screen-hero.png` — главная с моделью, фоном-дюной и водяным знаком
- `docs/screen-collection.png` — каталог из трёх карточек с ценами
- `docs/screen-product-modal.png` — модалка товара с выбором размера/цвета
- `docs/screen-order-form.png` — форма оформления заказа
- `docs/screen-auth.png` — Sign In gate со стеклянной плашкой на фоне текстуры
- `docs/screen-profile.png` — модалка профиля с формой контактов
